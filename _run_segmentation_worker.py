...
def main():
    ...
    # Config overrides (add all relevant ones from the node)
    parser.add_argument("--sam_points_per_side", type=int, required=True)
    parser.add_argument("--sam_pred_iou_thresh", type=float, required=True)
    parser.add_argument("--sam_stability_score_thresh", type=float, required=True)
    parser.add_argument("--sam_stability_score_offset", type=float, required=True)
    parser.add_argument("--samesh_min_area", type=int, required=True)
    parser.add_argument("--samesh_connections_bin_resolution", type=int, required=True)
    parser.add_argument("--samesh_connections_bin_thresh_perc", type=float, required=True)
    parser.add_argument("--samesh_smoothing_thresh_perc_size", type=float, required=True)
    parser.add_argument("--samesh_smoothing_thresh_perc_area", type=float, required=True)
    parser.add_argument("--samesh_smoothing_iterations", type=int, required=True)
    parser.add_argument("--samesh_repartition_lambda", type=int, required=True)
    parser.add_argument("--samesh_repartition_iterations", type=int, required=True)
